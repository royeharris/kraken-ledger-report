# Phase III-1 Bank Labels: Deposits/Withdrawals Alignment (v4.00-51)
...
## v4.00-51 Patch
- Fixed Statement Summary bank deposits aggregation to derive totals directly from Statement rows (bankRecords/sourceData).
- Updated 'No deposits' message text to 'No deposits found for this period.' for UI consistency.
