...
- simplify the logic
- optimise the logic
- refactor beyond what is explicitly stated
- reinterpret intent
- substitute alternative data sources
- merge steps or skip steps

The executing agent **must**:

- implement each patch exactly as written
- treat the Statement rows as the single source of truth
- preserve all existing correct behaviour outside the specified patches

Any deviation invalidates the fix.
